...
HOST_NAME="com.react_goto_component.open_in_vscode"
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
HOST_SCRIPT="$SCRIPT_DIR/native-host/open-in-vscode.py"
...
{
  "name": "$HOST_NAME",
  "description": "Opens files in VS Code for React Go to Component extension",
  "path": "$HOST_SCRIPT",
  "type": "stdio",
  "allowed_origins": [
